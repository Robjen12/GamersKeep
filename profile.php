...
while($row = $res->fetch_object())
{
	...
	if($grade > 0)
	{
		...
		$latestactivity .= <<<END
			...
			<button class="btn btn-default-span delete"><a class="span" href="delete.php?grid={$grid}"><span class="glyphicon glyphicon-remove pull-right" aria-hidden="true"></span></a></button>
